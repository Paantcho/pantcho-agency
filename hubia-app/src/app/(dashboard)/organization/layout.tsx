...
export default function OrganizationLayout({
  ...
  const activeIdx = orgTabs.findIndex(
  ...
  const linkRefs = useRef<(HTMLAnchorElement | null)[]>(Array(orgTabs.length).fill(null));
  ...
  return (
    <div className="hubia-fade-in flex flex-col gap-[24px]">
      <div className="flex items-center justify-between">
        <h1 className="text-heading-md text-ink-500">Organization</h1>
      </div>
