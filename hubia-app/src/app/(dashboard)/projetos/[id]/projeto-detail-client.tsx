            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="col-span-2">
                ...
                <input
                  ...
                  className="w-full h-10 rounded-[12px] bg-white border border-transparent px-3 text-[14px] text-[#0E0F10] outline-none focus:border-[#0E0F10] focus:ring-2 focus:ring-ink-500/10 transition-[border-color,box-shadow] duration-150"
                />
              </div>
              <div>
  ...
  return (
    <div className="flex gap-2 pt-2 border-t border-[#EEEFE9]">
      <input
        ...
        className="flex-1 h-9 rounded-[12px] border border-transparent bg-[#EEEFE9] px-3 text-[13px] text-[#0E0F10] outline-none placeholder:text-[#A9AAA5] focus:border-[#0E0F10] focus:ring-2 focus:ring-ink-500/10 transition-[border-color,box-shadow] duration-150"
      />
          ...
          <motion.div
            ...
            <div className="rounded-[16px] border-2 border-[#D7FF00] bg-[#FFFDE7] p-5 flex flex-col gap-3">
              ...
              <input
                ...
                className="h-10 w-full rounded-[12px] border border-transparent bg-white px-3 text-[13px] text-[#0E0F10] outline-none placeholder:text-[#A9AAA5] focus:border-[#0E0F10] focus:ring-2 focus:ring-ink-500/10 transition-[border-color,box-shadow] duration-150"
              />
              <textarea
                value={novaDesc} onChange={(e) => setNovaDesc(e.target.value)}
                placeholder="Descrição (opcional)"
                rows={2}
                className="w-full rounded-[12px] border border-transparent bg-white px-3 py-2 text-[13px] text-[#0E0F10] outline-none placeholder:text-[#A9AAA5] resize-none focus:border-[#0E0F10] focus:ring-2 focus:ring-ink-500/10 transition-[border-color,box-shadow] duration-150"
              />
              <div className="grid grid-cols-2 gap-3">
                <div>
      ...
      <AnimatePresence mode="wait">
        {!editing ? (
          ...
          <motion.textarea
            ...
            rows={8}
            className="w-full rounded-[12px] border border-transparent bg-[#EEEFE9] px-4 py-3 text-[14px] text-[#0E0F10] outline-none placeholder:text-[#A9AAA5] resize-none focus:border-[#0E0F10] focus:ring-2 focus:ring-ink-500/10 transition-[border-color,box-shadow] duration-150"
          />
        )}
      </AnimatePresence>
    </div>
