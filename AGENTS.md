...
│   ├── Agente: QA / Review — audita entregas, testa funcionalidades, reporta bugs com prioridade (🔴/🟡/🟢); 📍 `dev-squad/agents/qa-review/SOUL.md`; convocado automaticamente após cada sprint
